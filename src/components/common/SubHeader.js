        ...
        <>  
            <div className={SubHeaderCSS.subHeaderLayout}>
                <div className={SubHeaderCSS.subHeaderContainter}>
                    ...
                    <div className={SubHeaderCSS.subHeaderItem}>
                        <NavLink className={({isActive}) => isActive? SubHeaderCSS.subHeaderBorderActive : SubHeaderCSS.subHeaderBorder} to="/myPage/wishList1" style={{ textDecoration: "none" }}><div>판매목록</div></NavLink>
                    </div>
                    <div className={SubHeaderCSS.subHeaderItem}>
